...
export const MainContent = ({language, handleLanguageChange, code, handleCodeInput, output, handleCodeClear }:IMainContentProps) => {
  return (
    <div className="flex h-[calc(100vh-4rem)]">
      <SideBar language={language} handleLanguageChange={handleLanguageChange} />
      <div className="flex-1 flex">
      <CodeEditor code={code} handleCodeInput={handleCodeInput} />
